...
Este projeto consiste numa calculadora simples desenvolvida em Python, com uma interface gráfica baseada num mockup de iPhone.

O projeto está dividido em diferentes ficheiros, separando a lógica da aplicação da sua execução:
...
> **Nota:** o ficheiro `main.py` é o ficheiro utilizado para executar a aplicação.
